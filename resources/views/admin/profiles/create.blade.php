    ...
    <div class="row">
      <div class="col-12">
        <div class="card">
          ...
          <div class="card-body">
            <form action="{{ route('profile.store') }}" method="POST" novalidate enctype="multipart/form-data"
                ...
                <div class="col-lg-8">
                  <div class="row">
                        ...
                        <div class="mb-3 vertical-radius">
                          ...
                          <div class="input-group validate-username">
                            <input type="text" id="date-format" class="form-control br-style"
                              placeholder="Saturday 24 June 2024 - 21:44" required name="tanggal_berdiri">
                            <div class="invalid-feedback">
                              Please Enter a username.
                            </div>
                          </div>
                    ...
                    <div class="col-lg-6">
                      <div class="form-group">
                        <div class="mb-3 vertical-radius">
                          <label class="text-label form-label required" for="no_profile">Kode Kantor</label>
                          <div class="input-group validate-username">
                            <input type="text" class="form-control br-style" placeholder="Ex: 2374" required
                              name="no_profile" id="no_profile" maxlength="4">
                            <div class="invalid-feedback">
                              Please Enter a username.
                            </div>
                          </div>
                    ...
                    <div class="col-lg-12">
                      <div class="form-group">
                        <div class="mb-3 vertical-radius">
                          ...
                          <div class="input-group validate-username">
                            <textarea name="deskripsi" id="deskripsi" class="form-control br-style" rows="10" placeholder="Isi deskripsi..."></textarea>
                            <div class="invalid-feedback">
                              Please Enter a username.
                            </div>
                          </div>
